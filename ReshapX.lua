local ReshapeX, parent = torch.class('nn.ReshapeX', 'nn.Module')

function ReshapeX:__init(...)
   parent.__init(self)
   local arg = {...}
...
function ReshapeX:updateOutput(input)
...
function ReshapeX:updateGradInput(input, gradOutput)
...
function ReshapeX:__tostring__()
